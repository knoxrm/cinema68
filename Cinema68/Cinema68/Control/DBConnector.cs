...
namespace cinema68.Control
{
    class DBConnector : Controller
    {
        ...
        public void InsertData(SQLiteConnection conn)
        {
            ...
            //Fill Account Table
            sqlite_cmd.CommandText = "INSERT INTO `Account` (`name`, `email`, `password`, `is_admin`) Values(`Bill Huff`, `Cinema68Admin@gmail.com`, `2b6befb31d67a0527fbc2135063eafb13e0ada08406f7318206b7e8a`, `true`);";
            sqlite_cmd.ExecuteNonQuery();
            sqlite_cmd.CommandText = "INSERT INTO `Account`(`name`, `email`, `password`, `is_admin`) VALUES(`Jon Vick`, `jvick@gmail.com`,  `2b6befb31d67a0527fbc2135063eafb13e0ada08406f7318206b7e8a`, `false`);";
            sqlite_cmd.ExecuteNonQuery();
            sqlite_cmd.CommandText = "INSERT INTO `Account`(`name`, `email`, `password`, `is_admin`) VALUES(`Heather Howard`, `hhoward@gmail.com`,  `2b6befb31d67a0527fbc2135063eafb13e0ada08406f7318206b7e8a`, `false`);";
            sqlite_cmd.ExecuteNonQuery();
